      ...
      <div class="footer-widget mb-30">
        ...
        <div class="footer-list">
          <ul>
            ...
            <li><a href="pages/how-to-start-shopping.php">How to start shopping</a></li>
            
            <li><a href="pages/payment-option.php">Payment Option</a></li>
            
            <li><a href="pages/return-and-exchange.php">Return & Exchange Policy</a></li>
            
            <li><a href="pages/sizing-chart.php">Size Guide</a></li>
            
            <li><a href="pages/sizing-policy.php">Shipping Policy</a></li>
      ...
      <div class="footer-widget mb-30">
        ...
        <div class="footer-list">
          <ul>
            ...
            <li><a href="search.php">Our Store</a></li>
            
            <li><a href="pages/track-your-order.php">Track Your Order</a></li>
      ...
      <div class="footer-widget mb-30">
        ...
        <div class="footer-list">
          <ul>
            ...
            <li><a href="https://www.instagram.com/ppskhaul/">Instagram @ppskhaul</a></li>
            
            <li><a href="https://www.facebook.com/ppskhaul/">Facebook @ppskhaul</a></li>
...
<!--         <p>Copyright © 99 Shopify All Right Reserved.</p> -->
        Copyright © <b> Ppsk Haul</b> All Right Reserved.
      </div>
    </div>
          ...
          <div class="col-lg-6 col-md-6 col-12">
            <div class="qwick-view-right">
              <div class="qwick-view-content">
                ...
                <form id="add-item-qv" action="https://ppskhaul.com/cart/add" method="post">
  ...
  jQuery(function ($) {
    ...
    Shopify.onProduct = function(product) {
      ...
      if (desc.indexOf("[short_description]") >= 0) {
        ...
        $(_parent+' .product-des').php(text_truncate(product.description,250));
      }
          ...
          if(_var.available) {
            ...
            if(variant.inventory_management) {
              ...
              function changePriceValue (cell, value) {
                $(cell).php(Shopify.formatMoney(value, "<span class=money>RM{{amount}} MYR</span>"));
                                                 };
	  ...
	  if(jQuery(_parent+' .product-main-image__item .img_box_1').children().length > 0) {
                      ...
                      function changePriceValue (cell, value) {
                        jQuery(cell).php(Shopify.formatMoney(value, "<span class=money>RM{{amount}} MYR</span>"));
...
<script>
  ...
  jQuery('span.money').each(function() {
    jQuery(this).attr('data-currency-MYR', jQuery(this).php());
                      });
  ...
  $('[data-countdown]').each(function() {
    ...
    $this.countdown(finalDate, function(event) {
      $this.php(event.strftime('<div class="countdown-area"><div class="single-countdown"><div class="count-number">%D</div><div class="count-title">days</div></div><div class="single-countdown"><div class="count-number">%H</div><div class="count-title">Hour</div></div><div class="single-countdown"><div class="count-number">%M</div><div class="count-title">Mint</div></div><div class="single-countdown"><div class="count-number">%S</div><div class="count-title">Sec</div></div></div>'));
    });
  });
</script>
...
})(document, 'index.php\/\/sdk.boostflow.com\/js\/app.js');
</script>
...
$m("a").each(function() {
  ...
  if($m(this).attr("href") && $m(this).attr("href").replace(/\?.*/,"").toString().indexOf("products/index.php") != -1){
    var $mhandleArray = $m(this).attr('href').split("index.php");
                  ...
                  if(element.url.indexOf("view=quick") == -1){
                    $m("a").each(function() {
                      if($m(this).attr("href") && $m(this).attr("href").replace(/\?.*/,"") === element.url){
                        ...
                        if (element.price && $mmlvedamoney.php())
                        {
                          ...
                          $mmlvedamoney.each(function() {
                            if($mfirstMlvedamoney == null) {
                              ...
                              $msecondMlvedamoney = $m(this);//parseInt($m(this).php().replace(/[^0-9]/g, ""),10);
                            }
                            else {                              
                              return false;//parseInt($m(this).php().replace(/[^0-9]/g, ""),10)                              
                            }                           
                        ...
                        if($msecondMlvedamoney == null) {
                          $mfirstMlvedamoney.php(Shopify.formatMoney(element.price, "RM{{amount}} MYR"));
							if("undefined" != typeof element.compare_at_price){
	                               $m(this).parent().find(".percent-count").php("-"+(((element.compare_at_price - element.price)*100 )/ element.compare_at_price).toFixed()+"%");
	                        }
	                       else{
	                               $m(this).parent().find(".percent-count,.sale-title").remove();  
	                       }
                        }
                        else {                        var currentPrice = parseInt($msecondMlvedamoney.php().replace(/[^0-9]/g, ""),10);
                        var previousPrice = parseInt($mfirstMlvedamoney.php().replace(/[^0-9]/g, ""),10);
                            if ( currentPrice >= previousPrice ) {
                              if(!(element.compare_at_price) || parseInt(element.compare_at_price) <= parseInt(element.price)) {
                                $mfirstMlvedamoney.php(Shopify.formatMoney(element.price, "RM{{amount}} MYR"));
                                $msecondMlvedamoney.php("");
								$msecondMlvedamoney.removeClass("money");
                                $mfirstMlvedamoney.css("color","#000");
                                $msecondMlvedamoney.parent().hide();
                                $m(this).parent().find(".percent-count,.sale-title").remove();
                              } else {
                                $msecondMlvedamoney.php(Shopify.formatMoney(element.compare_at_price, "RM{{amount}} MYR"));
                                $mfirstMlvedamoney.php(Shopify.formatMoney(element.price, "RM{{amount}} MYR"));
							   $m(this).parent().find(".percent-count").php("-"+(((element.compare_at_price - element.price)*100 )/ element.compare_at_price).toFixed()+"%");
                              }
                              }
                                ...
                                if(!(element.compare_at_price) || parseInt(element.compare_at_price) <= parseInt(element.price)) {
                                  $msecondMlvedamoney.php(Shopify.formatMoney(element.price, "RM{{amount}} MYR"));                                            
                                  $mfirstMlvedamoney.php("");
								  $mfirstMlvedamoney.removeClass("money");
                                  $mfirstMlvedamoney.parent().hide();
                                  $msecondMlvedamoney.css("color","#000");
                                  $m(this).parent().find(".percent-count,.sale-title").remove();
                                } else {
                                  $mfirstMlvedamoney.php(Shopify.formatMoney(element.compare_at_price, "RM{{amount}} MYR"));
                                  $msecondMlvedamoney.php(Shopify.formatMoney(element.price, "RM{{amount}} MYR"));
                                  $m(this).parent().find(".percent-count").php("-"+(((element.compare_at_price - element.price)*100 )/ element.compare_at_price).toFixed()+"%");                                            
                                }
                              }
...
$acs('.money').each(function(){
       if (ACSCurrency.currentCurrency === "JOD" || ACSCurrency.currentCurrency === "KWD" || ACSCurrency.currentCurrency === "BHD") {
         var moneyraw = parseFloat($acs(this).php().replace(/[^0-9]/g, ""), 10) / 10 ;
       }
       else if( ACSCurrency.currentCurrency === "KRW" || ACSCurrency.currentCurrency === "JPY" || ACSCurrency.currentCurrency === "SEK" || ACSCurrency.currentCurrency === "HUF" || ACSCurrency.currentCurrency === "ISK") {
         var moneyraw = parseFloat($acs(this).php().replace(/[^0-9]/g, ""), 10) * 100 ;
       } else {
         var moneyraw = parseFloat($acs(this).php().replace(/[^0-9]/g, ""), 10)  ;
       }
...
{
  $acs(this).attr('data-currency-MYR', $acs(this).php());
}
});
...
if( typeof $ !== "undefined" ) {
  $(document).ajaxComplete(function(event, xhr, settings) {
     if(settings.url.indexOf("update.js")!=-1 || settings.url.indexOf("cart.js")!=-1 || settings.url.indexOf("add.php")!=-1 || settings.url.indexOf("change.js")!=-1) {
       setTimeout(function() {
         mlvedaload();
       }, 1000);
     }
...
<!-- Mirrored from ppskhaul.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Dec 2019 00:32:13 GMT -->
</html>
